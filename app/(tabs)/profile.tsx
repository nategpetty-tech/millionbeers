  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.background }}>
      <ScrollView contentContainerStyle={{ paddingBottom: 120 }}>
        <ScreenHeader title="Profile" subtitle="Your Pintly stats, challenges, badges, and beer identity." />
        <View style={{ paddingHorizontal: 20, gap: 14 }}>
          ...
          <SectionTitle title="Challenges" detail="Active routes you are still working toward." />
          {activeChallenges.length ? (
            ...
            <View style={{ backgroundColor: theme.colors.card, borderRadius: theme.radius.lg, borderWidth: 1, borderColor: theme.colors.border, padding: 16 }}>
              <Text style={{ color: theme.colors.text, fontWeight: "900" }}>All challenges complete</Text>
              <Text style={{ color: theme.colors.muted, marginTop: 5 }}>Completed challenge stamps live in your badges below.</Text>
            </View>
          )}
